...
export const createGasTableModule = ({
    ...
    const toggleGasQuickFilter = (e) => {
        ...
        html += '</div>';
        html += '<button type="button" data-action-click="toggleGasQuickFilter(event)" class="w-7 h-7 rounded border border-coffee-200 dark:border-[#44403c] bg-white dark:bg-[#1c1917] text-coffee-600 dark:text-[#a8a29e] hover:bg-coffee-50 dark:hover:bg-[#34302e] flex items-center justify-center" title="Close"><i class="fa-solid fa-xmark text-[11px]"></i></button>';
        html += '</div>';
        ...
        html += '<select id="gasQuickSortAddSelect" class="w-full px-2 py-1.5 rounded border border-coffee-200 dark:border-[#44403c] bg-white dark:bg-[#1c1917] text-xs text-coffee-900 dark:text-white">';
