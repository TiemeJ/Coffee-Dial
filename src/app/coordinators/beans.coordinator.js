...
export const createBeansCoordinator = ({
    ...
    const beansTable = createBeansTableModule({
        ...
        getCoffees: () => getCoffees(),
        getCoffeeTypes: () => getCoffeeTypes(),
        getPinnedBrewsPreferences: () => getPinnedBrewsPreferences?.(),
        ...
        getBeansSortKey: () => getBeansSortKey?.() || 'createdAt',
        setBeansSortKeyState: (value) => setBeansSortKeyState?.(value),
        getBeansSortDir: () => getBeansSortDir?.() || 'desc',
        setBeansSortDirState: (value) => setBeansSortDirState?.(value),
        getBeanCalculatedStock: (...args) => getBeanCalculatedStock(...args),
        getBeanCoffeeTypeDisplay: (...args) => getBeanCoffeeTypeDisplay(...args),
        getRoastBadge,
        dispatchCommand,
    ...
    return {
        ...
        setBeansSort: beansTable.setBeansSort,
        updateBeansSortIcons: beansTable.updateBeansSortIcons,
        getFilteredSortedBeans: beansTable.getFilteredSortedBeans,
        renderBeansTable: beansTable.renderBeansTable,
